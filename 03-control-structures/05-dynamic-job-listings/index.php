...
// create an array of job listings and assign it to a variable
$listings = [
  [
    'id' => 1,
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    ...
    <!-- Output -->
    <!-- use foreach to loop through listings -->
    <!-- loop through listings and check if index is even or odd and change bg color based on that -->
        ...
        <div class="<?php if ($index % 2 === 0) : ?>
          ...
          <div class="p-4">
            ...
            <ul class="mt-4">
              ...
              <!-- Check if tags array is not empty, if they are, remove the tags section altogether -->
