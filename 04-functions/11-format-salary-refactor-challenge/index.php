...
// Define a function to format the salary using an arrow function
...
// adding formatSalary to the calculateAverageSalary function as a callback
function calculateAverageSalary($listings, $formatSalary)
{
  ...
  // Format the average salary by converting formatSalary to a variable and passing it as a callback
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="bg-green-100 rounded-lg shadow-md p-6 my-6">
      <!-- adding formatSalary to the calculateAverageSalary as a callback -->
